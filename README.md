...
**Nigeria macro-economics research + a 7-model quantitative stack** — tracing one arc from raw
...
└── informal_economy_ai_bitcoin/           APPLICATION LAYER — the opportunity
    ...
    └── debt_cycle/                         ANALYSIS LAYER — macro engine + models
        ...
        ├── models: graph · VAR · SFC · scenario · GCN · positioning
...
2. **Analysis layer** (`.../debt_cycle/`) — a Big-Debt-Cycle diagnosis of Nigeria plus a
   **seven-model quantitative stack** and a strengthened **1980–2026** dataset.
